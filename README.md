...
User Story 4: A doctor has received a new patient, diagnosed with lyme disease. Their current prognosis is a flu strain, and they are worried the antibiotics they plan to prescribe will interfere with their current regime. The patient’s past physician is also connected with PhysiLink, therefore the doctor may compose a message directly to the past physician in order to get detailed information on the patient’s past treatments and prescriptions.
